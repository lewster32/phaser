...
Phaser.Cube.prototype = {
    ...
    * @method Phaser.Cube#size
    * @param {Phaser.Point3} [output] - Optional Point3 object. If given the values will be set into the object, otherwise a brand new Point3 object will be created and returned.
    * @return {Phaser.Point3} The size of the Cube object.
    */
    ...
    * @method Phaser.Cube#clone
    * @param {Phaser.Cube} [output] - Optional Cube object. If given the values will be set into the object, otherwise a brand new Cube object will be created and returned.
    * @return {Phaser.Cube}
    */
    ...
    * @method Phaser.Cube#intersects
    * @param {Phaser.Cube} b - The second Cube object.
    ...
    * @method Phaser.Cube#getCorners
    * @return {Phaser.Point3[]} The corners of this Cube expressed as an Array of eight Point3 objects.
    */
    getCorners: function () {
...
* @name Phaser.Cube#empty
* @property {boolean} empty - Gets or sets the Cube's empty state.
*/
Object.defineProperty(Phaser.Cube.prototype, "empty", {
...
* The size of the Cube object, expressed as a Point3 object with the values of the widthX, widthY and height properties.
* @method Phaser.Cube.size
* @param {Phaser.Cube} a - The Cube object.
* @param {Phaser.Point3} [output] - Optional Point3 object. If given the values will be set into the object, otherwise a brand new Point3 object will be created and returned.
* @return {Phaser.Point3} The size of the Cube object
*/
...
* @method Phaser.Cube.containsPoint3
* @param {Phaser.Cube} a - The Cube object.
* @param {Phaser.Point3} point3 - The Point3 object being checked. Can be Point3 or any object with .x, .y and .z values.
* @return {boolean} A value of true if the Cube object contains the specified point; otherwise false.
*/
...
* @method Phaser.Cube.containsCube
* @param {Phaser.Cube} a - The first Cube object.
* @param {Phaser.Cube} b - The second Cube object.
* @return {boolean} A value of true if the Cube object contains the specified point; otherwise false.
*/
Phaser.Cube.containsCube = function (a, b) {
