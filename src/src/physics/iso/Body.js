...
*
* @class Phaser.Physics.IsoArcade.Body
* @classdesc IsoArcade Physics Body Constructor
* @constructor
* @param {Phaser.Sprite} sprite - The Sprite object this physics body belongs to.
*/
Phaser.Physics.IsoArcade.Body = function (sprite) {

    /**
    * @property {Phaser.IsoSprite} sprite - Reference to the parent IsoSprite.
    */
    this.sprite = sprite;
    ...
    */
    this.type = Phaser.Physics.ISOARCADE;
    ...
    * @readonly
    */
    this.prev = new Phaser.Point3(this.position.x, this.position.y, this.position.z);
    ...
    */
    this.velocity = new Phaser.Point3();

    /**
    * @property {Phaser.Point3} newVelocity - New velocity.
    * @readonly
    */
    this.newVelocity = new Phaser.Point3();

    /**
    * @property {Phaser.Point3} deltaMax - The Sprite position is updated based on the delta x/y values. You can set a cap on those (both +-) using deltaMax.
    */
    this.deltaMax = new Phaser.Point3();

    /**
    * @property {Phaser.Point3} acceleration - The velocity in pixels per second sq. of the Body.
    */
    this.acceleration = new Phaser.Point3();

    /**
    * @property {Phaser.Point3} drag - The drag applied to the motion of the Body.
    */
    this.drag = new Phaser.Point3();
    ...
    */
    ...
    /**
    * @property {Phaser.Point3} gravity - A local gravity applied to this Body. If non-zero this over rides any world gravity, unless Body.allowGravity is set to false.
    */
    this.gravity = new Phaser.Point3();

    /**
    * @property {Phaser.Point3} bounce - The elasticitiy of the Body when colliding. bounce.x/y/z = 1 means full rebound, bounce.x/y/z = 0.5 means 50% rebound velocity.
    */
    this.bounce = new Phaser.Point3();

    /**
    * @property {Phaser.Point3} maxVelocity - The maximum velocity in pixels per second sq. that the Body can reach.
    * @default
    */
    this.maxVelocity = new Phaser.Point3(10000, 10000, 10000);
...
Phaser.Physics.IsoArcade.Body.prototype = {
    ...
    * Internal method.
    *
    * @method Phaser.Physics.IsoArcade.Body#updateBounds
    * @protected
    */
    updateBounds: function () {
        ...
        if (asx !== this._sx || asy !== this._sy) {
            this.widthX = (this.sourceWidthX * 0.5) * asx;
            this.widthY = (this.sourceWidthY * 0.5) * asx;
            this.height = (this.sourceHeight * 0.5) * asy;
    ...
    * Internal method.
    *
    * @method Phaser.Physics.IsoArcade.Body#preUpdate
    * @protected
    */
    preUpdate: function () {
    ...
    * Internal method.
    *
    * @method Phaser.Physics.IsoArcade.Body#postUpdate
    * @protected
    */
    postUpdate: function () {
        ...
        if (this.deltaX() < 0) {
            this.facing = Phaser.BACKX;
        }
        else if (this.deltaX() > 0) {
            this.facing = Phaser.FORWARDX;
        }

        if (this.deltaY() < 0) {
            this.facing = Phaser.BACKY;
        }
        else if (this.deltaY() > 0) {
            this.facing = Phaser.FORWARDY;
        }
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#destroy
    */
    destroy: function () {
    ...
    * Internal method.
    *
    * @method Phaser.Physics.IsoArcade.Body#checkWorldBounds
    * @protected
    */
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#setSize
    ...
    */
    setSize: function (widthX, widthY, height, offsetX, offsetY, offsetZ) {
        ...
        if (typeof offsetZ === 'undefined') { offsetZ = this.offset.z; }

        this.sourceWidthX = widthX;
        this.sourceWidthY = widthY;
        this.sourceHeight = height;
        this.widthX = (this.sourceWidthX * 0.5) * this._sx;
        this.widthY = (this.sourceWidthY * 0.5) * this._sx;
        this.height = (this.sourceHeight * 0.5) * this._sy;
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#onFloor
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#onWall
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaAbsX
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaAbsY
    * @return {number} The absolute delta value.
    */
    deltaAbsY: function () {
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaAbsZ
    * @return {number} The absolute delta value.
    */
    deltaAbsZ: function () {
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaX
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaY
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaZ
    * @return {number} The delta value. Positive if the motion was downwards, negative if upwards.
    */
    deltaZ: function () {
    ...
    *
    * @method Phaser.Physics.IsoArcade.Body#deltaR
...
/**
* @name Phaser.Physics.IsoArcade.Body#top
* @property {number} bottom - The top value of this Body (same as Body.z + Body.height)
* @readonly
*/
Object.defineProperty(Phaser.Physics.IsoArcade.Body.prototype, "top", {
...
/**
* @name Phaser.Physics.IsoArcade.Body#frontX
* @property {number} right - The front X value of this Body (same as Body.x + Body.widthX)
* @readonly
*/
Object.defineProperty(Phaser.Physics.IsoArcade.Body.prototype, "frontX", {
...
* @readonly
*/
Object.defineProperty(Phaser.Physics.IsoArcade.Body.prototype, "frontY", {
...
*/
Object.defineProperty(Phaser.Physics.IsoArcade.Body.prototype, "x", {
...
/**
* @name Phaser.Physics.IsoArcade.Body#y
* @property {number} y - The y position.
*/
Object.defineProperty(Phaser.Physics.IsoArcade.Body.prototype, "y", {
...
/**
* @name Phaser.Physics.IsoArcade.Body#z
* @property {number} z - The z position.
*/
Object.defineProperty(Phaser.Physics.IsoArcade.Body.prototype, "z", {
...
*/
Phaser.Physics.IsoArcade.Body.render = function (context, body, color, filled) {
...
*/
Phaser.Physics.IsoArcade.Body.renderBodyInfo = function (debug, body) {
...
Phaser.Physics.IsoArcade.Body.prototype.constructor = Phaser.Physics.IsoArcade.Body;
